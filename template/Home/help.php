...
<li class="active"><a href="#"><i class="icon fa fa-info-circle"></i>功能简介</a></li>';
...
echo '<div class="panel-body box">';
foreach($qqTaskNames as $func)
echo '<span class="btn btn-default btn-sm">'.$func.'</span>&nbsp;';
echo '
</div>';
echo '<div class="panel-heading w h"><h3 class="panel-title">签到功能一览</h3></div>';
echo '<div class="panel-body box">';
foreach($signTaskNames as $func)
echo '<span class="btn btn-default btn-sm">'.$func.'</span>&nbsp;';
echo '
</div>';
...
echo '●<b>如何添加签到任务？</b><br/>1.注册登录系统后进入自动签到。<br/>2.在任务列表上方点击“添加网站签到任务”。<br/>3.进入相应的签到模块根据提示完成任务添加。';
echo '</div>';
